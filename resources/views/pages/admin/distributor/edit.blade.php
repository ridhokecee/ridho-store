...
<div class="main-content">
    <section class="section">
        ...
        <div class="card mt-4">
            <form action="{{ route('distributor.update', $distributors->id) }}" class="needs-validation" novalidate=""
                        ...
                        <div class="col-6">
                            <div class="form-group">
                                ...
                                <input id="nama_distributor" type="text" class="form-control" name="nama_distributor" 
                                    value='{{$distributors->nama_distributor}}' required>
                        ...
                        <div class="col-6">
                            <div class="form-group">
                                ...
                                <input id="lokasi" type="text" class="form-control" name="lokasi" 
                                    value='{{$distributors->lokasi}}' required="">
                                <div class="invalid-feedback">
                                    Kolom ini harus di isi!
                                </div>
                            </div>
                        ...
                        <div class="col-6">
                            <div class="form-group">
                                ...
                                <input id="kontak" type="text" class="form-control" name="kontak" 
                                    value='{{$distributors->kontak}}' required="">
                                <div class="invalid-feedback">
                                    Kolom ini harus di isi!
                                </div>
                            </div>
                        ...
                        <div class="col-6">
                            <div class="form-group">
                                ...
                                <input id="email" type="text" class="form-control" name="email" 
                                    value='{{$distributors->email}}'required="">
                                <div class="invalid-feedback">
                                    Kolom ini harus di isi!
                                </div>
                            </div>
